...
void loop()
{
  ...
  servo1.write(150);   // Tell servo to go to 150 degrees

  delay(1000);         // Pause to give it time to move

  servo1.write(30);    // Tell servo to go to 30 degrees
  ...
  for(servo_angle = 0; servo_angle < 180; servo_angle += 2)
  {
    servo1.write(servo_angle);  // Move to next position
